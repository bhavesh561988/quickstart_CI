...
$(window).load(function() {
	$('#myTab a[href="#<?=$this->uri->segment(2);?>"]').tab('show');
});
</script>
<?php }?>
<div class="row-fluid">
	  <div class="box span12">
		<div class="box-header well" data-original-title>
			<h2><i class="icon-edit"></i> <?php echo $this->lang->line('waddress_profile');?></h2>
...
<?php } ?>
			<ul class="nav nav-tabs" id="myTab">
				...
				<?php //if($query->plan_id != 1):?>
					<li><a id="deal_id"  href="#deals"><?php echo $this->lang->line('tab_deal');?></a></li>
				<?php }?>
                                        
                                        <li><a id="subscription_id" href="#subscription"><?php echo $this->lang->line('tab_subscription');?></a></li>
			</ul>
				...
				<div class="tab-pane active" id="Personal_details">
	                ...
	                <!--User Last Name -->
						<div class="control-group">
							...
							<div class="controls">						
								<input type="text" id="last_name" name="last_name" value="<?php if(set_value('last_name') == ""){ echo (isset($query->last_name))?$query->last_name:''; } else { echo set_value('last_name'); }?>" class="input-xlarge">
							</div>
						</div>
					...
					<!--Intro text  -->
						<div class="control-group">
							...
							<div class="controls ">						
								<textarea name="intro_text" id="intro_text"><?php if(set_value('intro_text') == ""){ echo (isset($query->intro_text))?$query->intro_text:''; } else { echo set_value('intro_text'); }?></textarea>
					...
					<!-- area_code  -->
						<div class="control-group">
							...
							<div class="controls ">						
								<input type="text" id="area_code" name="area_code" value="<?php echo (isset($query->area_code))?$query->area_code :'';?><?php echo set_value('area_code'); ?>" class="input-xlarge">
							</div>
					    </div>			
					<!--Phone-->
						<div class="control-group">
							...
							<div class="controls">						
								<input type="text" id="phone" name="phone" value="<?php echo (isset($query->phone))?$query->phone:'';?><?php //echo set_value('phone'); ?>" class="input-xlarge">
							</div>
						</div>
					<!--City-->
						<div class="control-group">
					...
					<!--User subcription_date on -->
							...
							<div class="controls">						
                                ...
                                <input type="text" class="input-xlarge datepicker" id="subcription_date" name="subcription_date" value="<?php echo (isset($query->subcription_date))?$query->subcription_date:'';?><?php echo set_value('created'); ?>">
							</div>
						</div>	
					<!--User expiry_date on -->
	                        <div class="control-group">
							...
							<div class="controls">						
								<input type="text" class="input-xlarge datepicker" id="expiry_date" name="expiry_date" value="<?php echo (isset($query->expiry_date))?$query->expiry_date:'';?><?php echo set_value('created'); ?>">
							</div>
						</div>	
	                <!--User created on -->
	                        <div class="control-group">
							...
							<div class="controls">						
								<input type="text" class="input-xlarge datepicker" id="created" name="created" value="<?php echo (isset($query->created))?$query->created:'';?><?php echo set_value('created'); ?>">
							</div>
						</div>    		
	...
	<!-- Business Deatails  -->
				<div class="tab-pane" id="business">
		                ...
		                <!--company_name -->
		                    <div class="control-group">
									<label class="control-label" for="company_name"><?php echo $this->lang->line('id_name');?></label>
									<div class="controls">						
										...
										<input type="text" id="business_company_name" name="business_company_name" value="<?php if(set_value('business_company_name') == ""){echo (isset($query_business->company_name))?$query_business->company_name:''; } else { echo set_value('business_company_name'); }?>" class="input-xlarge">
						...
						<div class="control-group" style="display:none">
							...
							<div class="controls" style="display:none;" >						
								...
								if(!isset($query_business->business_pic) || $query_business->business_pic == "" ){ 	$image = 'default/no_image.jpg'; } else { $image = $query_business->business_pic; } ?>
								<span class="alignright add-img">
						...
						<div class="control-group">
							...
							<div class="controls">						
								...
								if(!isset($query_business->brand_logo) || $query_business->brand_logo == "" ){ 	$image = 'default/add-img.png'; } else { $image = $query_business->brand_logo; } ?>
								<span class="alignright add-img">
						        <img src="<?= $this->config->item('image_directory')?>user/<?=$image?>" width="136" height="136" class="preview" alt="add image" title="add image" />
						      </span>
		                ...
		                <!-- address_1 of user -->
		                    ...
		                    <div class="control-group">
									...
									<div class="controls">						
										...
										<input type="text" id="business_phone" name="business_phone" value="<?php if(set_value('business_phone') == ""){echo (isset($query_business->phone))?$query_business->phone:''; } else { echo set_value('business_phone'); }?>" class="input-xlarge">
		                    ...
		                    <div class="control-group">
									...
									<div class="controls">						
										...
										<input type="text" id="business_web_address" name="business_web_address" value="<?php if(set_value('business_web_address') == ""){echo (isset($query_business->web_address))?$query_business->web_address:''; } else { echo set_value('business_web_address'); }?>" class="input-xlarge">
		                    ...
		                    <div class="control-group">
									<label class="control-label" for="intro_text" ><?php echo $this->lang->line('intro_text');?></label>
									<div class="controls">	
									<textarea id="business_intro_text" class="input-xlarge" name="business_intro_text"><?php echo (isset($query_business->intro_text))?$query_business->intro_text:'';?><?php echo set_value('business_intro_text'); ?></textarea>					
										<!-- <input type="text" class="input-xlarge"id="business_intro_text" name="business_intro_text" value="<?php echo (isset($query_business->intro_text))?$query_business->intro_text:'';?><?php echo set_value('business_intro_text'); ?>" class="input-xlarge"> -->
									</div>
							</div>
						...
						<input type="hidden" name="user_id" value="<?php echo $this->session->userdata('wid');//echo @$query->id;?>">	
						</fieldset>
 ...
 -->
						    ...
						    <div class="form-actions">
								<!--<input name="submit" class="btn btn-primary" type="button" value="<?php echo $this->lang->line('save');?>">-->
								<a href="<?php echo base_url('users/editwaddress/'.$this->uri->segment(3)); ?>" class="btn">Cancel</a>
							</div>
						<input type="hidden" name="user_id" value="<?php echo $this->session->userdata('wid'); //@$query->id;?>">	
						</fieldset>
...
<div><span class="help-inline">Leave blank if you don't extend<br/>Special privilage - Set User Expiry Date form here </span></div>
								   ...
								   <input type="hidden" name="w_id" value="<?php echo @$query->id;?>">                         
							  </tbody>
						 </table>  

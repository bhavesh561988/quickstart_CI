...
<div class="row-fluid">		
	<div class="box-header well" data-original-title>
			<h2><i class="icon-shopping-cart"></i> <?php echo $this->lang->line('plan_type'); ?></h2>
			<div class="box-icon">
	...
	<div id="container">				
		...
		<table cellpadding="0" cellspacing="0" border="0" class="display" id="example">
			<thead>
				...
				<th width="20%"><?php echo $this->lang->line('plan_status');?></th>
	...
	$('#example').dataTable( {
		...
		"aoColumns": [
            ...
            { "mDataProp": function( data, type, val ) {
            	return '<a class="btn btn-mini btn-info" href="<?php echo base_url(); ?>plantype/edit/'+data[0]+'"><i class="icon-edit icon-white"></i></a> <a class="btn btn-mini btn-danger" href="<?php echo base_url(); ?>plantype/delete/'+data[0]+'"><i class="icon-trash icon-white"></i></a>';
            },"bSortable":false }
        ]
	} );

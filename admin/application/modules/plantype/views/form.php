			...
			<?php echo form_open('','class="form-horizontal"'); ?>
				<fieldset>
					...
					<div class="control-group">
                        	<label class="control-label" for="name"><?php echo $this->lang->line('plan_type_name');?></label>
                            <div class="controls">	
                        ...
                        <div class="control-group">
						<label class="control-label" for="status"><?php echo $this->lang->line('plan_status');?></label>
						<div class="controls">

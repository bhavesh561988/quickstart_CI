...
class Planmodel extends CI_Model
{
    ...
    function get() {
        ...
        $aColumns = array("$this->planTable.id",
            ...
            "$this->planTable.price",
            "$this->planTable.currency",
            "$this->planTypeTable.name",
            "$this->planTable.duration_number");
        $aColumnsAlias = array('id', 'title', 'price', 'currency', 'name', 'duration_number');
	...
	function getById($id)
	{
		$this->db->select("$this->planTable.id, $this->planTable.plan_type_id, $this->planTable.title, $this->planTable.price, $this->planTable.currency, $this->planTable.duration_number");

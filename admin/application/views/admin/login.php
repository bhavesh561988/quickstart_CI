	...
	<div class="row-fluid">
		...
		<div class="row-fluid">
			<div class="span12 center login-header">
				<h2><?php echo $this->lang->line('login_welcome_text');?></h2>
			</div><!--/span-->
		</div><!--/row-->
			...
			<div class="well span5 center login-box">
				...
				<?php else : ?>
					<div class="alert alert-info">
						<?php echo $this->lang->line('login_alert_text');?>
					</div>
				<?php endif; ?>
				<!-- /messages section -->	
				...
				<?php echo form_open('admin/login', array('name'=>"login", 'class'=>"form-horizontal")); ?>
					<fieldset>
						<div class="input-prepend" title="Email adddress" data-rel="tooltip">
							<span class="add-on"><i class="icon-user"></i></span>
							<input autofocus class="input-large span10" name="email" id="email" type="text"  value="<?php echo set_value('email'); ?>" />
						</div>
						<div class="clearfix"></div>

						<div class="input-prepend" title="<?php echo $this->lang->line('password');?>" data-rel="tooltip">
						...
						<button type="submit" class="btn btn-primary"><?php echo $this->lang->line('login');?></button>
                                                ...
                                                <div class="input-prepend" title="<?php echo $this->lang->line('forgotpassword');?>" data-rel="tooltip">
